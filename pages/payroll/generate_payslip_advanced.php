...
if (!$employee_id) {
    // Enhanced employee selection page
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Advanced Payslip Generation</title>
                    ...
                    <div class="col-lg-8">
                        <div class="glass-card rounded-4 p-4 mb-4">
                            <h1 class="text-center mb-4">
                                ...
                                Advanced Payslip Generator
                            </h1>
                            <p class="text-center opacity-75">
                                Generate professional payslips with advanced features and multiple templates
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-5">
                            <form method="GET" id="payslipForm">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label for="employee_id" class="form-label fw-bold">
                                            <i class="bi bi-person-circle text-primary"></i> Select Employee
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="month" class="form-label fw-bold">
                                            <i class="bi bi-calendar3 text-primary"></i> Pay Period
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="template" class="form-label fw-bold">
                                            <i class="bi bi-palette text-primary"></i> Template Style
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="format" class="form-label fw-bold">
                                            <i class="bi bi-file-earmark text-primary"></i> Output Format
                                        </label>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-grid">
                                            <a href="payroll.php" class="btn btn-outline-secondary btn-lg hover-scale">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-3">
                                            <a href="bulk_payslips.php" class="btn btn-outline-info btn-sm w-100 hover-scale">
                                                <i class="bi bi-files"></i> Bulk Generate
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a href="payslip_history.php" class="btn btn-outline-warning btn-sm w-100 hover-scale">
                                                <i class="bi bi-clock-history"></i> History
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a href="payroll_settings.php" class="btn btn-outline-secondary btn-sm w-100 hover-scale">
                                                <i class="bi bi-gear"></i> Settings
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <button class="btn btn-outline-success btn-sm w-100 hover-scale" onclick="generateSample()">
                                                <i class="bi bi-eye"></i> Sample
                                            </button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 no-print">
                    <div>
                        <h1 class="h3 mb-0">Advanced Payslip</h1>
                        <p class="text-muted">
                    ...
                    <div class="btn-toolbar">
                        ...
                        <div class="btn-group me-2">
                            <button onclick="sendEmail()" class="btn btn-warning">
                                <i class="bi bi-envelope"></i> Email
                            </button>
                            <button onclick="sharePayslip()" class="btn btn-secondary">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="?employee_id=<?= $employee_id ?>&month=<?= $month ?>&template=modern">Modern</a></li>
                                <li><a class="dropdown-item" href="?employee_id=<?= $employee_id ?>&month=<?= $month ?>&template=classic">Classic</a></li>
                                <li><a class="dropdown-item" href="?employee_id=<?= $employee_id ?>&month=<?= $month ?>&template=minimal">Minimal</a></li>
                                <li><a class="dropdown-item" href="?employee_id=<?= $employee_id ?>&month=<?= $month ?>&template=colorful">Colorful</a></li>
                            </ul>
                        </div>
                        
                        <a href="payroll.php" class="btn btn-outline-secondary ms-2">
