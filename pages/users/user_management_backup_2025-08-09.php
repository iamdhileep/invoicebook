    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h4 mb-1 fw-bold text-primary">👥 User Management</h1>
                    <p class="text-muted small mb-0">
                        <i class="bi bi-people"></i> 
                        Manage system users, roles, and permissions
                        <span class="badge bg-light text-dark ms-2">Admin Panel</span>
                    </p>
                </div>
                        ...
                        <div class="card-body text-white">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <p class="mb-0 small">Administrators</p>
                                </div>
                    ...
                    <div class="card border-0 h-100" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
                        <div class="card-body text-white">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <i class="bi bi-circle-fill text-success" style="font-size: 2rem; opacity: 0.7;"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="mb-0 fw-semibold">Users List</h6>
                        </div>
                        <div class="col-auto">
