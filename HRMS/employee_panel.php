...
if (!HRMSHelper::isLoggedIn()) {
    header('Location: ../hrms_portal.php?redirect=HRMS/employee_panel.php');
    exit;
}
...
try {
    ...
    if (!empty($employee['department_id'])) {
        $deptResult = HRMSHelper::safeQuery("SELECT * FROM hr_departments WHERE id = {$employee['department_id']} LIMIT 1");
