<?php
/**
 * AI-Powered HR Analytics & Predictive Intelligence Dashboard
 * Advanced machine learning insights for workforce optimization
 */
...
if (!HRMSHelper::isLoggedIn()) {
    header('Location: ../hrms_portal.php?redirect=HRMS/ai_hr_analytics.php');
    exit;
}
