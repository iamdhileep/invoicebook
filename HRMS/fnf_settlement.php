...
// Fetch FnF settlement data from database
$pending_settlements = [];
$result = mysqli_query($conn, "
    SELECT id, employee_code as employee_id, employee_name as name, 
           department_name as department, last_working_day, 
           net_settlement as settlement_amount, status, 
