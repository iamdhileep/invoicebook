...
$total_employees_query = "SELECT COUNT(*) as total FROM employees WHERE status = 'active'";
...
$avg_salary_query = "SELECT AVG(monthly_salary) as avg_salary FROM employees WHERE monthly_salary > 0 AND status = 'active'";
...
$total_payroll_query = "SELECT SUM(monthly_salary) as total_payroll FROM employees WHERE monthly_salary > 0 AND status = 'active'";
