...
if ($row['count'] == 0) {
    ...
    $insertDepartments = "
    INSERT IGNORE INTO departments (department_name, description, budget) VALUES
    ...
    $insertEmployees = "
    INSERT IGNORE INTO employees (name, employee_code, position, department_id, email, phone, monthly_salary, joining_date, date_of_birth) VALUES
