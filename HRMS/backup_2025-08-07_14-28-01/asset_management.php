...
$employees = $conn->query("SELECT id, first_name, last_name, employee_id FROM hr_employees WHERE status = 'active' ORDER BY first_name, last_name");
if (!$employees) {
    $employees = $conn->query("SELECT id, first_name, last_name, employee_id FROM hr_employees ORDER BY first_name, last_name");
}
