    ...
    if (sidebarToggleButton && sidebar) {
        sidebarToggleButton.addEventListener('click', function(e) {
            ...
            if (isCollapsed) {
                ...
                // Emit custom event for header coordination
...
function initializeSidebarToggle() {
    ...
    document.addEventListener('sidebarToggle', function() {
        ...
        if (sidebar) {
            ...
            // Emit state change event back to header
            const stateEvent = new CustomEvent('sidebarStateChanged', {
                detail: { collapsed: !isCurrentlyCollapsed }
            });
            document.dispatchEvent(stateEvent);
            console.log('Sidebar: sidebarStateChanged event dispatched', { collapsed: !isCurrentlyCollapsed });
        } else {
